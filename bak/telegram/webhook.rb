        ...
        def process
            ...
            when '/my_timezone'
                ...
                if timezone
                    ...
                    @telegram_api.send_message(chat_id, "You haven't set a timezone yet. Use /set_timezone to set it.")
                end
            when '/set_timezone'
                settings = @upstash.get_hash(chat_id.to_s)
            ...
            when '/remove_timezone'
                ...
                @telegram_api.send_message(chat_id, "Your timezone has been removed. You can set it again with /set_timezone")
            else
                settings = @upstash.get_hash(chat_id.to_s)
